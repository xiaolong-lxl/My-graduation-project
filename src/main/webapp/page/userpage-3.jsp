...
<div class="container theme-showcase" role="main">
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-md-12 column">
                <form id="upUser" name="form1" action="/tbUser/upTbUser" method="post" class="form-horizontal" role="form">
                    <div class="form-group ">
                        <label>
                            用户名
                            <span id="sp" >用户名不能为空或用户名长度最短8字符</span>
                        </label>
                        <input id="userAccount" name="userAccount" readonly type="text" maxlength="255" value="${account}"
                               class="form-control"
                    ...
                    <div class="form-group ">
                        ...
                        <input id="userPassword" name="userPassword" type="password" maxlength="50"
                    ...
                    <div class="form-group ">
                        ...
                        <input id="reuserPassword" name="reuserPassword" type="password" maxlength="50"
...
$(function () {
    ...
    $('#update').click(function panduan() {
        ...
        if ($("#userAccount").val() == "" || $("#userAccount").val().length <4) {
